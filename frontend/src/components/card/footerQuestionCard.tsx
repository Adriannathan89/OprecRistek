...
interface FooterQuestionCardProps {
    ...
    setEditAnswerMode: React.Dispatch<React.SetStateAction<boolean>>;
}

export default function FooterQuestionCard({ question, setEditAnswerMode, onQuestionDelete, onQuestionChange }: FooterQuestionCardProps) {
        ...
        <div className="flex justify-between w-full mt-[24px]">
            <div>
                ...
                className="flex gap-[12px] cursor-pointer">
                    <ListTodo size={20} className="text-gray-400 mt-[2px]" />
                    <p className="text-gray-400 mb-[4px]">Answer Key</p>
                </div>
            </div>
